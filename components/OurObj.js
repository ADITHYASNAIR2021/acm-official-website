...
function OurObj() {
  return (
      ...
      <div className='h-[100vh] ourobjbg'>
        ...
        <div className="grid grid-rows-2 grid-flow-col gap-1 w-[45%]">
          <div className='flex justify-center'>
        <div className=" grid place-items-center text-center ">
        <div className="grid grid-rows-2 ">
          
          <p className='ourobjtxt '> OUR OBJECTIVE</p>
            <p className="text-xl break-words pl-12 pr-12 font-light">The objective of the chapter to promote computer science as a field of education and foster a sense of innovation and creativity among computer enthusiasts.</p>
        </div>
</div>
</div>
<div className='flex justify-center'>
  ...
  <ObjRec className="scale-75"/>
    <div className="font-bold text-xl ml-4 text-center">Interactive</div></div>
...
<div className="w-full rounded border-2 border-blue-700 card-gradient">
  ...
  <div className='flex items-center justify-center'>
  <ObjRec className="scale-75"/>
    <div className="font-bold text-xl ml-4 text-center">Big Ideas</div></div>
    <p className="text-white text-base text-center font-light">
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
  </div>
