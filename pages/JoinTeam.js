        ...
        <div className="flex flex-col gap-y-24 xl:w-[90%] mt-10 mb-5">
          <div className="flex lg:grid">
            <div className="grid grid-rows-3 lg:grid-cols-3 lg:grid-rows-1 place-items-center text-center">
              <div className="flex lg:grid">
                <p className="jointext flex items-center justify-center flex-wrap ">
                  JOIN
                </p>
                <p className="ourteam flex items-center justify-center flex-wrap ">
                  OUR TEAM
                </p>
              </div>
          ...
          <div className="flex justify-center">
            <div className=" grid grid-cols-1 sm:grid-cols-3 gap-24 w-3/4 sm:w-4/5">
              {detArr.map((pgdet) => (
                <div
                  className="w-full rounded border-2 border-blue-700 card-gradient"
                  key={pgdet.id}
                >
